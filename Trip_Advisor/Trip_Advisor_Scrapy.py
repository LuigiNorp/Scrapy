...
class TripAdvisor(CrawlSpider):
    ...
    def parse_item(self, response):
        ...
        # Other Price Options
        item.add_xpath('price_large',
                       prices_span,
                       MapCompose(self.del_money_sign))

        item.add_xpath('seller_large',
                       sellers_span)
